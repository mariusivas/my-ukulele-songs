...
import com.mivas.myukulelesongs.viewmodel.CustomizeChordsSongViewModel
import kotlinx.android.synthetic.main.activity_customize_chords_song.*
import org.jetbrains.anko.alert

class CustomizeChordsSongActivity : AppCompatActivity() {

    private lateinit var viewModel: CustomizeChordsSongViewModel

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_customize_chords_song)
    ...
    private fun initViewModel() {
        viewModel = ViewModelProviders.of(this).get(CustomizeChordsSongViewModel::class.java)
    }
    ...
    private fun initViews() {
        supportActionBar?.run {
            ...
            title = getString(R.string.customize_song_activity_title_chords)
        }
